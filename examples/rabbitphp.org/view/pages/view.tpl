...
<p>
  ...
  Layouts are the general design for the website, they wrap the view file output.  Layout files required the tag {literal}{$view}{/literal}
...
<p>
  ...
  {$view} tag appears.  Also, other smarty variables are available as you can see the page_title could be returned from the
  controller also, or maybe returned from a before_action interceptor.
</p>
<a name="#elements"></a>
<h3>Elements</h3>
<p>
  Elements are reusable view files that are placed in the app/view/elements directory and rendered with the {literal}{render}{/literal} tag.
